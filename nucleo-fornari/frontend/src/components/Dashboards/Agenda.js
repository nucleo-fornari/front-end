...
function Agenda(props) {
    ...
    const agenda = [
        ...
        },
        {
            ...
            conteudo: "Revisar os capítulos 1 e 2 para a prova na próxima sexta-feira.",
            autor: "Profª Carla",
            dataCriacao: "Quarta-Feira, 5 de Novembro"
        },
        {
            titulo: "Lanche Compartilhado",
            conteudo: "Cada aluno deve trazer um prato para compartilhar na sexta-feira.",
            autor: "Profª Renata",
            dataCriacao: "Quinta-Feira, 6 de Novembro"
        },
        {
            titulo: "Leitura de História",
            conteudo: "Ler o livro 'O Menino e o Balão Vermelho' para a roda de leitura.",
            autor: "Profª Júlia",
            dataCriacao: "Sexta-Feira, 7 de Novembro"
        },
        {
            titulo: "Atividade de Arte",
            conteudo: "Trazer tinta guache e pincel para a atividade de pintura na segunda-feira.",
            autor: "Profª Paula",
            dataCriacao: "Sexta-Feira, 7 de Novembro"
        },
        {
            titulo: "Passeio ao Zoológico",
            conteudo: "Levar autorização assinada e R$20 para o passeio do dia 12 de Novembro.",
            autor: "Profª Silvia",
